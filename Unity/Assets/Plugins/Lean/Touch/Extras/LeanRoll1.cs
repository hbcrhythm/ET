...
namespace Lean.Common
{
	...
	[ExecuteInEditMode]
	[HelpURL(LeanHelper.HelpUrlPrefix + "LeanRoll1")]
	[AddComponentMenu(LeanHelper.ComponentPathPrefix + "Roll1")]
	public class LeanRoll1 : MonoBehaviour
	{
		...
		{
			Debug.Log($"IncrementAngle  {delta}");
			Angle += delta;
		}
...
namespace Lean.Common.Inspector
{
	...
	[CustomEditor(typeof(LeanRoll1))]
	public class LeanRoll1_Inspector : LeanInspector<LeanRoll1>
	{
